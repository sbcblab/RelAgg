...
dataset_file   = "DATA/encoded_snp.csv" # path to data file (must be .csv, features as columns, first row and first column are labels, first column after labels should contain the classes or target values)
...
class_colors   = ['GREEN', 'ORANGE', 'BLUE'] # list of colors to be assigned to the classes in the data, options as below:
